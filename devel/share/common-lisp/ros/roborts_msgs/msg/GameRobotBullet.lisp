...
(cl:defclass <GameRobotBullet> (roslisp-msg-protocol:ros-message)
  ((red1
    :reader red1
    :initarg :red1
    :type cl:fixnum
...
(cl:defclass GameRobotBullet (<GameRobotBullet>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <GameRobotBullet>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'GameRobotBullet)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roborts_msgs-msg:<GameRobotBullet> is deprecated: use roborts_msgs-msg:GameRobotBullet instead.")))

(cl:ensure-generic-function 'red1-val :lambda-list '(m))
(cl:defmethod red1-val ((m <GameRobotBullet>))
...
(cl:defmethod red2-val ((m <GameRobotBullet>))
...
(cl:defmethod blue1-val ((m <GameRobotBullet>))
...
(cl:defmethod blue2-val ((m <GameRobotBullet>))
  ...
  (blue2 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <GameRobotBullet>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GameRobotBullet>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GameRobotBullet>)))
  "Returns string type for a message object of type '<GameRobotBullet>"
  "roborts_msgs/GameRobotBullet")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GameRobotBullet)))
  "Returns string type for a message object of type 'GameRobotBullet"
  "roborts_msgs/GameRobotBullet")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GameRobotBullet>)))
  "Returns md5sum for a message object of type '<GameRobotBullet>"
  "fdaec03d4604469fd40ee7049d826d6e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GameRobotBullet)))
  "Returns md5sum for a message object of type 'GameRobotBullet"
  "fdaec03d4604469fd40ee7049d826d6e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GameRobotBullet>)))
  "Returns full string definition for message of type '<GameRobotBullet>"
  (cl:format cl:nil "#game robot bullet~%uint16 red1~%uint16 red2~%uint16 blue1~%uint16 blue2~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GameRobotBullet)))
  "Returns full string definition for message of type 'GameRobotBullet"
  (cl:format cl:nil "#game robot bullet~%uint16 red1~%uint16 red2~%uint16 blue1~%uint16 blue2~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <GameRobotBullet>))
  (cl:+ 0
     2
     2
     2
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <GameRobotBullet>))
  "Converts a ROS message object to a list"
  (cl:list 'GameRobotBullet
