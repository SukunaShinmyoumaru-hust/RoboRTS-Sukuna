...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RobotDamage>)))
  ...
  "2bc7f08d7afff0fbeeeb47c67a382a42")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RobotDamage)))
  "Returns md5sum for a message object of type 'RobotDamage"
  "2bc7f08d7afff0fbeeeb47c67a382a42")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RobotDamage>)))
  ...
  (cl:format cl:nil "#robot damage~%uint8 ARMOR = 0~%uint8 OFFLINE = 1~%uint8 EXCEED_SHOOT_SPEED = 2~%uint8 EXCEED_SHOOT_HEAT = 3~%uint8 EXCEED_CHASSIS_POWER = 4~%uint8 OBSTACLE_COLLISION = 5~%uint8 damage_type~%~%uint8 FORWARD = 0~%uint8 LEFT = 1~%uint8 BACKWARD = 2~%uint8 RIGHT = 3~%uint8 damage_source~%~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RobotDamage)))
  "Returns full string definition for message of type 'RobotDamage"
  (cl:format cl:nil "#robot damage~%uint8 ARMOR = 0~%uint8 OFFLINE = 1~%uint8 EXCEED_SHOOT_SPEED = 2~%uint8 EXCEED_SHOOT_HEAT = 3~%uint8 EXCEED_CHASSIS_POWER = 4~%uint8 OBSTACLE_COLLISION = 5~%uint8 damage_type~%~%uint8 FORWARD = 0~%uint8 LEFT = 1~%uint8 BACKWARD = 2~%uint8 RIGHT = 3~%uint8 damage_source~%~%~%~%~%"))
