...
namespace roborts_global_planner{
    ...
    ErrorInfo AStarPlanner::SearchPath(const int &start_index,
        ...
        bool right = (goal_index % gridmap_width_) > (start_index % gridmap_width_);
        bool down = (goal_index / gridmap_width_) > (start_index / gridmap_width_);
        ...
        while (!openlist.empty()) {
            ...
            for (auto neighbor_index : neighbors_index) {
                ...
                GetMoveCost(current_index, neighbor_index, move_cost, down, right);
